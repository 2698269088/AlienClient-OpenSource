...
public interface IEventBus {
    ...
    /**
     * Finds all correct (static and non-static) methods with {@link EventListener} annotation and subscribes them.
     *
    ...
    /**
     * Finds all correct (static only) methods with {@link EventListener} annotation and subscribes them.
     *
    ...
    /**
     * Finds all correct (static and non-static) methods with {@link EventListener} annotation and unsubscribes them.
     *
     * @param object The object to scan for methods
     */
    ...
    /**
     * Finds all correct (static only) methods with {@link EventListener} annotation and unsubscribes them.
     *
     * @param klass The class to scan for methods
     */
