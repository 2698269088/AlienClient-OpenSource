...
public class EntityUtil implements Wrapper {
    ...
    public static boolean inInventory() {
        return mc.currentScreen == null || mc.currentScreen instanceof GameOptionsScreen || mc.currentScreen instanceof OptionsScreen || mc.currentScreen instanceof PeekScreen || mc.currentScreen instanceof ChatScreen || mc.currentScreen instanceof InventoryScreen || mc.currentScreen instanceof ClickGuiScreen || mc.currentScreen instanceof GameMenuScreen;
    }
