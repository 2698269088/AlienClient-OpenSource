...
public class Tracers extends Module {
    ...
    private void drawLine(Vec3d pos, Color color) {
        Render3DUtil.drawLine(pos, mc.gameRenderer.getCamera().getPos().add(Vec3d.fromPolar(mc.player.getPitch(mc.getRenderTickCounter().getTickDelta(true)), mc.player.getYaw(mc.getRenderTickCounter().getTickDelta(true))).multiply(0.2)), color);
    }
}
